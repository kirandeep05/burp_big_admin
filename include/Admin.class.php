...
class Admin {
    ...
    public function checkAdId($ad_id) {

        $query = "SELECT COUNT(*) as total FROM `bb_advertisement` WHERE `ad_id` = :ad_id";

        $qh = $this->con->getQueryHandler($query, array("ad_id"=>$ad_id));
    ...
    public function deleteAdvertisement($id) {
        ...
        $query = "DELETE FROM `bb_advertisement` WHERE `ad_id` = :ad_id";

        $bindParams = array("ad_id" => $id);
    ...
    public function updateAdvertisement($hotel_id,$cover_pic,$type_id,$start_date,$end_date,$ad_id) {
    ...
    public function getAdvertisement() {
        ...
        $query = "SELECT ba.`ad_id`,ba.`ad_hotel_id`,bh.`hotel_name`, br.`rest_name`,bat.`ad_type_name` "
                . "FROM "
                . "`bb_advertisement` ba, `bb_hotel` bh, `bb_rest` br, `bb_ad_type` bat WHERE "
                . "ba.`ad_hotel_id` = bh.`hotel_id` AND bh.`rest_id` = br.`rest_id` AND ba.`ad_type_id` = bat.`ad_type_id`";
     ...
     public function getAdvertisementFromHotelID($ad_id) {
        ...
        $query = "SELECT `ad_hotel_id`, `ad_cover_pic`, `ad_type_id`, `ad_start_date`, `ad_end_date` "
                . "FROM `bb_advertisement` WHERE "
                . "`ad_id` = :ad_id";
